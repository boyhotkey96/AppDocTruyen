package com.boyhotkey96.funnystories.Fragment.GopY;
...
//            Snackbar.make(activity_main, "Welcome " + FirebaseAuth.getInstance().getCurrentUser().getEmail(), Snackbar.LENGTH_SHORT).show();
    ...
    private void displayChatMessage() {
        ...
        adapter = new FirebaseListAdapter<ItemChatMessage>(this, ItemChatMessage.class, R.layout.chat_list_item, FirebaseDatabase.getInstance().getReference()) {
            @Override
